...
signal.items = null;
signal.map = null;
signal.markerClusterer = null;
signal.markers = [];
signal.infoWindow = null;
...
signal.icons = {
    'dgps':     new google.maps.MarkerImage(base_image + '/pins/dgps.png',     new google.maps.Size(12, 20)),
    'dsc':      new google.maps.MarkerImage(base_image + '/pins/dsc.png',      new google.maps.Size(12, 20)),
    'hambcn':   new google.maps.MarkerImage(base_image + '/pins/hambcn.png',   new google.maps.Size(12, 20)),
    'navtex':   new google.maps.MarkerImage(base_image + '/pins/navtex.png',   new google.maps.Size(12, 20)),
    'ndb':      new google.maps.MarkerImage(base_image + '/pins/ndb.png',      new google.maps.Size(12, 20)),
    'time':     new google.maps.MarkerImage(base_image + '/pins/time.png',     new google.maps.Size(12, 20)),
    'other':    new google.maps.MarkerImage(base_image + '/pins/other.png',    new google.maps.Size(12, 20)),
    'inactive': new google.maps.MarkerImage(base_image + '/pins/inactive.png',  new google.maps.Size(12, 20))
};
...
signal.showMarkers = function() {
    ...
    for (i = 0; i < signals.length; i++) {
        ...
        fn = signal.markerClickFunction(s, latLng);
...
signal.markerClickFunction = function(s, latlng) {
    return function(e) {
        ...
        var infoHtml =
            ...
            '  </table>' +
            '</div>';
        signal.infoWindow.setContent(infoHtml);
        signal.infoWindow.setPosition(latlng);
        signal.infoWindow.open(signal.map);
    };
};
